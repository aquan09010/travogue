    ...
    >
      <View style={styles.mainView}>
        <View style={styles.flex}>
          <SvgXml xml={FireIcon} />
          <Text style={styles.title}>Các điểm ăn uống không thể bỏ lỡ</Text>
        </View>
        <FlatList
          data={DATA}
      ...
      <View style={styles.mainView}>
        <View style={styles.flex}>
          <SvgXml xml={BookIcon} />
          <Text style={styles.title}>Khám phá các “ẩm thực” MICHELIN</Text>
        </View>
        <FlatList
          data={DATA}
          renderItem={renderItem}
      ...
      <View style={styles.mainView}>
        <View style={styles.flex}>
          <SvgXml xml={BookIcon} />
          <Text style={styles.title}>Các thành phố du lịch ẩm thực</Text>
        </View>
        <FlatList
          data={DATA}
