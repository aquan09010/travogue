...
export default function TicketInfo({ route }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={{ height: "87%" }}>
        <View style={styles.containerCard}>
          ...
          <View style={styles.orderCard}>
            <Text style={styles.textDetail}>abc</Text>
            ...
            <View style={[styles.line]}>
              ...
              <Text style={[styles.text]}> 1 người lớn, 2 trẻ em, 3 em bé</Text>
            </View>
            <Pressable style={styles.line1} onPress={gotoHost}>
              <Text style={{ alignSelf: "center", marginRight: 5 }}>
                ...
                <Text style={{ fontSize: 16 }}> a@gmail.com</Text>
              </Text>
        ...
        <View style={styles.mainView}>
          ...
          <View style={styles.line3}>
            ...
            <Text style={{}}>x1</Text>
            <Text style={{}}>đ20000</Text>
          </View>
          <View style={styles.line3}>
            <Text style={{}}>Vé trẻ em</Text>
            <Text style={{}}>x2</Text>
            <Text style={{}}>đ30000</Text>
          </View>
          <View style={styles.line3}>
            <Text style={{}}>Vé em bé</Text>
            <Text style={{}}>x3</Text>
            <Text style={{}}>đ10000</Text>
          </View>
          <View style={styles.line3}>
      ...
      <View style={[styles.frameParent4]}>
        ...
        >
          <Text style={{ color: "#fff", alignSelf: "center" }}>Từ chối</Text>
        </Pressable>
        <Pressable
        ...
        >
          <Text style={{ color: "#fff", alignSelf: "center" }}>Phê duyệt</Text>
        </Pressable>
      </View>
    </SafeAreaView>
  );
